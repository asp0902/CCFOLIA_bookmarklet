...
(() => {
  ...
  console.info("[CCF NAR] format-sync IIFE entry v0.1.0 @", new Date().toISOString());
  ...
  const CCF_FORMAT_SYNC_SCRIPT_INFO = Object.freeze({
    ...
    version: getUserscriptVersion("0.0.37"),
    namespace: "https://greasyfork.org/users/Capybara_korea/ccf-format-sync"
  });
...
(() => {
  ...
  function snapChatScrollToBottomAfterSend() {
    ...
    [200, 600, 1200].forEach((delay) => setTimeout(snap, delay));
  }
